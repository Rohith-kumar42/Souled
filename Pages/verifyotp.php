...
<body id="transparentBG" style="background-color: #1b2838;">
    ...
    <?php endif; ?>
    <a href="checkout.php" style="text-decoration:none;"><button type="submit" class="smallFont" style="display: block;width: 25%; margin-left: 37%;height: 50px ;background-image: linear-gradient(to right, #3786c6 , #223e87);margin-top:-500px">
