...
$sql = "SELECT size, count FROM muhome";
...
$sql = "INSERT INTO muquantity (size,quantity) VALUES ('$size1','$quantity')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['size1']) && isset($_POST['quantity'])) {
    $selectedSize = $_POST['size1'];
    $quantity = $_POST['quantity'];

    // Update the count value in the table based on the selected size
    $sql1 = "UPDATE muhome SET count = count - $quantity WHERE size = '$selectedSize'";
...
$Jerseyname = "MANCHESTER UNITED HOME KIT 2023-2024";
$page_url="mu.php";
  // Save the size and quantity to the cart table
 $sql2 = "INSERT INTO cart (name, size, quantity,price,page_url) VALUES ('$Jerseyname', '$size1', '$quantity',3599*$quantity,'$page_url')";
  ;
         ...
         id="demo" class="carousel slide carousel-fade vid-carousel" data-ride="carousel" data-interval="false">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../assets/Images/manunited1.webp" style="height: 800px; padding: 15px;background-size: contain;">
            </div>
            <div class="carousel-item">
              <img src="../assets/Images/manunited2.webp" style="height: 800px; padding: 15px;background-size: contain;">
            </div>
            <div class="carousel-item">
              <img src="../assets/Images/manunited3.webp" style="height: 800px; padding: 15px;background-size: contain;">
            </div>
            <div class="carousel-item">
                <img src="../assets/Images/manunited4.webp" style="height: 800px; padding: 15px;background-size: contain;">
              </div>
              <div class="carousel-item">
                <img src="../assets/Images/manunited5.webp" style="height: 800px; padding: 15px;background-size: contain;">
              </div>
              <div class="carousel-item">
                <img src="../assets/Images/manunited6.webp" style="height: 800px; padding: 15px;background-size: contain;">
              </div>
              <div class="carousel-item">
                <img src="../assets/Images/manunited7.webp" style="height: 800px; padding: 15px;background-size: contain;">
              </div>
              <div class="carousel-item">
                <img src="../assets/Images/manunited8.webp" style="height: 800px; padding: 15px;background-size: contain;">
              </div>
          </div>
          ...
          <div class="smallFont" style="display: inline-block; font-weight: 600; font-size: 20px; padding-left: 5px; margin-top: 25px;">
                Purchase MANCHESTER UNITED HOME KIT 2023-2024
            </div>
            <div class="product-single__quantity">
            <label style="margin-left: 10px;color: white;font-size: 20px;">Size</label>
            <input type="text" id="size1" name="size1" name="size" value="" style="width: 60px;margin-left: 20px;margin-top: 20px;height: 40px;">
            ...
            <ul class="" style="width: 190px;margin-left: 710px;margin-top: -880px;list-style-type: none;">
              <li data-target="#demo" data-slide-to="0" class="active" style="background-image: url(../assets/Images/mu1.avif);height: 85px;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
              <li data-target="#demo" data-slide-to="1" style="background-image: url(../assets/Images/mu2.avif);height: 85px;background-size: contain;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
              <li data-target="#demo" data-slide-to="2" style="background-image: url(../assets/Images/mu3.avif);height: 85px;background-size: contain;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
              <li data-target="#demo" data-slide-to="3" style="background-image: url(../assets/Images/mu4.avif);height: 85px;background-size: contain;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
              <li data-target="#demo" data-slide-to="4" style="background-image: url(../assets/Images/mu5.avif);height: 85px;background-size: contain;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
              <li data-target="#demo" data-slide-to="5" style="background-image: url(../assets/Images/mu6.avif);height: 85px;background-size: contain;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
              <li data-target="#demo" data-slide-to="6" style="background-image: url(../assets/Images/mu7.avif);height: 85px;background-size: contain;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
              <li data-target="#demo" data-slide-to="7" style="background-image: url(../assets/Images/mu8.avif);height: 85px;background-size: contain;background-repeat: no-repeat;width: 155px;background-size: cover;"></li><br>
...
<br>
        ...
        width: 60%; height: 150px; background-image: linear-gradient(to right, rgb(45, 61, 74) , rgb(87, 101, 116));">
            ...
            <div id="price" style="background-color: black; float: right; padding: 5px; margin-top: 20px;">
                    <span style="color: #c5d3de; position: relative; top: 8px; padding-right: 12px;">₹3599 RUP</span>
